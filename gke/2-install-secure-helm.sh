...
# upstream source:
# https://github.com/jonbcampos/kubernetes-series/tree/master/helm/scripts/add_secure_helm.sh
# blog post:
# https://medium.com/google-cloud/install-secure-helm-in-gke-254d520061f7

export SUBJECT="/C=US/CN=example.com"

echo "create RBAC config"
...
kubectl create -f helm/role-tiller.yaml
kubectl create -f helm/rolebinding-tiller.yaml
...
echo "move certs"
# you copy them so you don't need to include them with every call to helm
