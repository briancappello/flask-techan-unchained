      ...
      <div className="row">
        <div className="six cols offset-by-three">
          ...
          <form onSubmit={handleSubmit(signUp)}>
            <TextField name="firstName" className="full-width" autoFocus />
            <TextField name="lastName" className="full-width" />
            <TextField name="username" className="full-width" />
...
export default compose(withForm, withSagas)(SignUp)
