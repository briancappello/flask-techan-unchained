...
export default class MACD {
  ...
  draw() {
    ...
    this.svg.append('g').attr('class', 'macd axis')

    this.yAxisRight = d3.axisRight(this.yScale).ticks(5).tickSizeOuter(0)
    ...
    this.macd = techan.plot
      .macd()
      .xScale(this.xScale)
      .yScale(this.yScale)
      .accessor(this.accessor)

    this.svg.append('g').attr('class', 'indicator macd')
  }
  ...
  drawCrosshairs() {
    ...
    this.svg.append('g').attr('class', 'macd crosshair')
  ...
  drawLegend(latestBar) {
    ...
    this.legendSignalValue = this.svg
      .append('text')
