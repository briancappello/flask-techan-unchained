...
export default class RSI {
  ...
  draw() {
    ...
    this.svg.append('g').attr('class', 'rsi axis')

    this.yAxisRight = d3.axisRight(this.yScale).tickValues(rsiTicks)
    ...
    // indicator
    this.rsi = techan.plot.rsi().xScale(this.xScale).yScale(this.yScale)
    ...
    this.svg.append('g').attr('class', 'indicator rsi')
  }
  ...
  drawCrosshairs() {
    ...
    this.svg.append('g').attr('class', 'rsi crosshair')
